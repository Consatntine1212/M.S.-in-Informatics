...
$sql = "INSERT INTO data(firstname, lastname, phonenum, mobilenum, mail, xora, city, adres, zip, cardtype, cardnumb) VALUES ('".$_POST['name']."','".$_POST['sername']."','".$_POST['phonenum']."','".$_POST['mobilenum']."','".$_POST['email']."','".$_POST['xora']."','".$_POST['city']."','".$_POST['adres']."','".$_POST['zip']."','".$_POST['cardtype']."','".$_POST['curdnumb']."')";
